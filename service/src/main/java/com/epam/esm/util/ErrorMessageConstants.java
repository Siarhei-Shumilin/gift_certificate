...
public class ErrorMessageConstants {
    public static final String CERTIFICATE_INCORRECT = "certificate.field.incorrect";
    public static final String TAG_INCORRECT = "tag.field.incorrect";
    public static final String USER_EXISTS = "user.exists";
    public static final String FAILED_AUTHENTICATION = "user.not.authorized";
