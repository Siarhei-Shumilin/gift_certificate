...
public class CertificateValidator {
    ...
    public boolean validate(GiftCertificate giftCertificate) {
        ...
        boolean positivePrice = isMoreZero.test(giftCertificate.getPrice().intValue());
        boolean duration = isMoreZero.test(giftCertificate.getDuration());
        boolean emptyName = giftCertificate.getName().trim().isEmpty();
        boolean emptyDescription = giftCertificate.getDescription().trim().isEmpty();
