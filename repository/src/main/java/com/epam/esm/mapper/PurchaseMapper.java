...
public interface PurchaseMapper {
    @Insert("INSERT INTO purchases (user_id, certificate_id, price, date_purchase) VALUES (#{userId},#{certificateId}, (select price from certificates where id = #{certificateId}),#{dateTime})")
